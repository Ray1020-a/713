...
const helpContent = {
	shellType: {
		header: '煙火類型',
		body: '是一個選擇煙火的選項，選擇“隨機（Random）”可以獲得很棒的體驗！'
	},
	shellSize: {
		header: '煙火大小',
		body: '煙火越大範圍就越大，但是煙火越大，設備硬體占用也會增多，大的煙花可能導致你的設備卡頓。'
	},
	quality: {
		header: '畫質',
		body: '如果動畫運行不流暢，你可以試試降低畫質。畫質越高，煙火施放後的火花數量就越多，但高畫質可能導致你的設備卡頓。'
	},
	skyLighting: {
		header: '天空明亮度',
		body: '煙火爆炸時，背景會被照亮。如果你的屏幕看起來太亮了，可以把它改成“暗”或者“不”。'
	},
	scaleFactor: {
		header: '縮放大小',
		body: '使你與煙火離得更近或更遠。對於較大的煙火，你可以選擇更小的縮放值，尤其是在手機或平板電腦上。'
	},
	autoLaunch: {
		header: '自動放煙火',
		body: '開啟後會自動施放煙火，您也可以關閉透過點擊螢幕手動施放'
	},
	finaleMode: {
		header: '同時放更多煙火',
		body: '可以在同一時間自動施放出更多的煙火（但需要開啟先開啟“自動放煙火”）。'
	},
	hideControls: {
		header: '隱藏控制按鈕',
		body: '隱藏屏幕頂部的按鈕。如果你要截圖，或者需要一個完美的體驗，你就可以將隱藏按鈕，隱藏按鈕後你仍然可以在右上角打開設置。'
	},
	fullscreen: {
		header: '全螢幕',
		body: '切換成全螢幕模式'
